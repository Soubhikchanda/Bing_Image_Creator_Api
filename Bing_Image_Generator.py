import random, re, time, json, requests
...
class Image_Gen:
    ...
    def Generate(self,prompt: str)-> list:
        ...
        urls=[f"{bing}/images/create?q={url_encoded_prompt}&rt=4&FORM=GENCRE"]
        for i in urls:
...
def Bing_Image_API(cookies,prompt):
    generator=Image_Gen(all_cookies=json.load(cookies))
